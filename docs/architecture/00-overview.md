...
| [14-advanced.md](./14-advanced.md) | Advanced 扩展点桶：middleware、StreamAggregator、SSE、FallbackAdapter、resilient loop（test utils 已 Wave-27 拆出） |
...
| [17-testing.md](./17-testing.md) | Testing 子路径：mock `AgentAdapter` 工厂（Wave-27 从 `/advanced` 拆出） |
