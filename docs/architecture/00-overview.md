...
| 指标 | 值 |
|------|---|
| 源码文件（全仓库 src，不含 __tests__） | 237 个 .ts 文件（其中 core 包 148） |
| 测试文件 | 185 个 .test.ts 文件（其中 core 包 145） |
| 测试用例 | 4,483（Wave-24 baseline） |
...
| [01-core.md](./01-core.md) | Agent Loop、共享类型、错误层级（Wave-by-wave 变更见 [`01-core-changelog.md`](./01-core-changelog.md)） |
